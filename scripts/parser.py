...
url = 'http://www.tyzicos.com/ville-concerts/rennes'
...
output_file = "concerts_rennes.csv"
with open(output_file, "w", newline="", encoding="utf-8") as csvfile:
    fieldnames = ["Date", "Concert", "Lieu", "Ville", "Heure", "Prix"]
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(concerts)

print(f"Concert data has been written to {output_file}")